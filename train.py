...
if __name__ == '__main__':
    ...
    # --cfg 指定模型文件
    parser.add_argument('--cfg', type=str, default='models/yolov5s-demo.yaml', help='model.yaml path')
    # parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    # --data(⭐)指定数据文件
    parser.add_argument('--data', type=str, default='data/demo.yaml', help='data.yaml path')
    # --hyp 指定超参数文件
